...
<div id="zhuhaivariety">
    <div><a id="zhuhaivarietyhead">澳门</a></div>
    <div >
        <ul >
...
<!--<div>-->
<!--<ul>-->
            <!--<li><img src="${AoMenPhoto.get(2) }"><a href="./jump?flag=${AoMenTitle.get(2)}">${AoMenTitle.get(2)}</a></li>-->
            <!--<li><img src="${AoMenPhoto.get(5) }"><a href="./jump?flag=${AoMenTitle.get(5)}">${AoMenTitle.get(5)}</a></li>-->
            <!--<li><img src="${AoMenPhoto.get(3) }"><a href="./jump?flag=${AoMenTitle.get(3)}">${AoMenTitle.get(3)}</a></li>-->
<!--</ul>-->
<!--</div>-->
<!--<div><a href="#">更多</a></div>-->
...
<div class="container-fluid" id="like">
 ...
 <div class="row clearfix">
        <div class="col-md-4 column">
            <img src="${AoMenPhoto.get(0) }" class="img-rounded"/>
            <span class="suibian"><a href="./jump?flag=${AoMenTitle.get(0)}">${AoMenTitle.get(0)}</a></span>
        </div>
        <div class="col-md-4 column">
            <img src="${AoMenPhoto.get(1) }" class="img-rounded"/>
            <span class="suibian"><a href="./jump?flag=${AoMenTitle.get(1)}">${AoMenTitle.get(1)}</a></span>
        </div>
        <div class="col-md-4 column">
            <img src="${AoMenPhoto.get(2) }" class="img-rounded"/>
            <span class="suibian"><a href="./jump?flag=${AoMenTitle.get(2)}">${AoMenTitle.get(2)}</a></span>
        </div>
          <div class="col-md-4 column">
            <img src="${AoMenPhoto.get(3) }" class="img-rounded"/>
            <span class="suibian"><a href="./jump?flag=${AoMenTitle.get(3)}">${AoMenTitle.get(3)}</a></span>
        </div>
        <div class="col-md-4 column">
            <img src="${AoMenPhoto.get(4) }" class="img-rounded"/>
            <span class="suibian"><a href="./jump?flag=${AoMenTitle.get(4)}">${ZhuHaiTitle.get(4)}</a></span>
        </div>
        <div class="col-md-4 column">
            <img src="${AoMenPhoto.get(5) }" class="img-rounded"/>
            <span class="suibian"><a href="./jump?flag=${AoMenTitle.get(5)}">${AoMenTitle.get(5)}</a></span>
        </div>
          </div>
    
  
     <li><a id="more" href="./ShowAoMenDetail">更多</a></li>
</div>
<!--当地美食栏目-->
